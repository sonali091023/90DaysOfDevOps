...
-->This task is meant to help you understand the difference between Automated Sync and Manual Sync in ArgoCD by actually changing your application's configuration and observing ArgoCD's behavior.
